...
<body>
<h1 class="text-center jumbotron">Libaray Information System</h1>
...
<nav>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <h1 class="page-header">Issued Books</h1>
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td><%=rs.getString("bookCallno") %></td>
                            <td><%=rs.getString("studentid") %></td>
                            <td><%=rs.getString("studentname") %></td>
                            <td><%=rs.getString("studentcontact") %></td>
